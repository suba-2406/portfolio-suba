...
import { InternshipsVisual } from './SectionVisuals';
  ...
  return (
    <section id="experience" className="py-16 scroll-mt-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="relative border-l-2 border-primary-500/30 pl-8 ml-4">
            {portfolioData.internships.map((internship, index) => (
              ...
              >
                ...
                <div className="glass-card p-6 rounded-2xl border border-white/20 dark:border-white/10 shadow-xl">
        ...
        {/* Right Side: 3D Animated Video Simulation */}
        <motion.div 
